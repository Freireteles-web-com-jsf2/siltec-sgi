...
export default function MemberFormEdit({ isOpen, onClose, member, onSave }) {
  ...
  useEffect(() => {
    if (member) {
      setFormData({
        ...
        email: member.email || '',
        phone: member.phone || '',
        department: member.department || 'Ministério Jovem',
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Editar Membro" size="md">
